            ...
            <div className="col-12">
                <div className="card">
                    ...
                    >
                        ...
                        <Column field="precio" header="Precio" sortable headerStyle={{ minWidth: '15rem' }}></Column>
                        <Column field="stock" header="Stock" sortable headerStyle={{ minWidth: '15rem' }}></Column>
                    ...
                    <Dialog visible={productDialog} style={{ width: '450px' }} header="Product Details" modal className="p-fluid" footer={productDialogFooter} onHide={hideDialog}>
                        ...
                        <div className="field">
                            ...
                            {submitted && !product.descripcion && <small className="p-invalid">Name is required.</small>}
                        </div>
                        <div className="field">
                            <label htmlFor="precio">Precio</label>
                            <InputText id="precio" value={product.precio} onChange={(e) => onInputChange(e, 'precio')} required autoFocus className={classNames({ 'p-invalid': submitted && !product.precio })} />
                            {submitted && !product.precio && <small className="p-invalid">Name is required.</small>}
                        </div>
                        <div className="field">
                            ...
                            {submitted && !product.stock && <small className="p-invalid">Name is required.</small>}
                        </div>
                    </Dialog>
